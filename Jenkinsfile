        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/YamilV18/SysAlmacenPruebas.git'
                }
            }
        }
        stage('Build') {
